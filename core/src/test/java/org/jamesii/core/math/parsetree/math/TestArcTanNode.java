...
public class TestArcTanNode extends TestValueNodeAbstract<ArcTanNode, INode> {
  ...
  @Override
  protected ArcTanNode getInstance(INode content) {
    return new ArcTanNode(content);
  }
