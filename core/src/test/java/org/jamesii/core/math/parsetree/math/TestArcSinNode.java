...
public class TestArcSinNode extends TestValueNodeAbstract<ArcSinNode, INode> {
  ...
  @Override
  protected ArcSinNode getInstance(INode content) {
    return new ArcSinNode(content);
  }
