...
import org.jamesii.core.util.eventset.UnsortedListEventQueue;

/**
 * Tests the {@link UnsortedListEventQueue}.
 * 
 * @author Jan Himmelspach
 * 
 * 
 */
public class UnsortedListEventQueueTest extends EventQueueTest {
   ...
   *          the name
   */
  public UnsortedListEventQueueTest(String name) {
    super(name);
  }
