...
/**
 * Node that represents a "is-not-equal" relation.
 * 
...
public class IsNotEqualNode extends BinaryNode {
   ...
   */
  private static final long serialVersionUID = 2449356500072236688L;

  /**
   * Instantiates a new checks if is not equal node.
   * 
   * @param left
   *          the left
   * @param right
   *          the right
   */
  public IsNotEqualNode(INode left, INode right) {
    super(left, right);
  }
