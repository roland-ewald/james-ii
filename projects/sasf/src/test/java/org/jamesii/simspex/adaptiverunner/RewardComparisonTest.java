...
import org.jamesii.simspex.adaptiverunner.policies.RewardComparisonFactory;
import org.jamesii.simspex.adaptiverunner.policies.plugintype.MinBanditPolicyFactory;


/**
 * Tests {@link RewardComparison}.
 * 
 * @author Rene Schulz
 * 
 */
public class RewardComparisonTest extends TestPolicyPerformance {

  @Override
  protected Pair<MinBanditPolicyFactory, ParameterBlock> getPolicySetup() {
    return new Pair<MinBanditPolicyFactory, ParameterBlock>(
        new RewardComparisonFactory(), new ParameterBlock());
  }
