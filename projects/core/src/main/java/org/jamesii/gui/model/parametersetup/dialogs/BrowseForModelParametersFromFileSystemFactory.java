...
/**
 * Factory for the parameter dialog for browsing and opening model parameter
 * files.
 * 
 * @author Stefan Rybacki
 */
public class BrowseForModelParametersFromFileSystemFactory
    extends
  ...
  public IFactoryParameterDialog<ModelParameterFileReaderFactory> createDialog(
    ...
    return new BrowseForModelParametersFromFileSystem(factoryDialogParameter);
  }
