...
import org.jamesii.gui.utils.objecteditor.property.provider.ListItemProperty;
 ...
 * {@link ObjectEditorComponent} when providing custom {@link IPropertyProvider}
 ...
 * <p/>
 * To work properly with {@link ObjectEditorComponent} it is crucial to provide
 * a appropriate {@link #hashCode()} and {@link #equals(Object)} implementation.
 * Have also a look at {@link AbstractProperty} where such an implementation
 * already is provided.
 * 
 * @author Stefan Rybacki
 * @see ListPropertyProvider
 * @see ListItemProperty
