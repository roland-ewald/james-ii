...
/**
 * Node that represents a "is-greater-or-equal" relation.
 * 
 * @author Jan Himmelspach
 */
public class IsGreaterOrEqualNode extends BinaryNode {

  /**
   * The constant serial version id.
   */
  private static final long serialVersionUID = 7636242471688672746L;

  /**
   * Instantiates a new checks if is greater or equal node.
   * 
   * @param left
   *          the left
   * @param right
   *          the right
   */
  public IsGreaterOrEqualNode(INode left, INode right) {
    super(left, right);
  }
