...
/**
 * Super class of all experiment suite writer factories that create file
 * writers.
 * 
 * @author Stefan Rybacki
 */
public abstract class ExperimentSuiteFileWriterFactory extends
    ExperimentSuiteWriterFactory implements IFileHandling {
