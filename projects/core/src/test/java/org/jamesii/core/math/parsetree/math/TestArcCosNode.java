...
public class TestArcCosNode extends TestValueNodeAbstract<ArcCosNode, INode> {
  ...
  @Override
  protected ArcCosNode getInstance(INode content) {
    return new ArcCosNode(content);
  }
