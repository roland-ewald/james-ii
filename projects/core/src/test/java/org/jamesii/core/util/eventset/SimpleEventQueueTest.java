...
/**
 * Tests the {@link org.jamesii.core.util.eventset.SimpleEventQueue}.
 * 
 * @author Roland Ewald
 * 
 * 
 */
public class SimpleEventQueueTest extends EventQueueTest {
   ...
   *          the name
   */
  public SimpleEventQueueTest(String name) {
    super(name);
  }
