...
public class TestCeilingNode extends TestValueNodeAbstract<CeilingNode, INode> {
  ...
  @Override
  protected CeilingNode getInstance(INode content) {
    return new CeilingNode(content);
  }
