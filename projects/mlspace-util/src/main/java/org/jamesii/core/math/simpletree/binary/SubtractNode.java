 ...
 * @date 11.03.2014
 */
public final class SubtractNode extends AbstractBinaryNode {

  public SubtractNode(DoubleNode leftSub, DoubleNode rightSub) {
  ...
  protected DoubleNode simplerCopy(DoubleNode left, DoubleNode right) {
    ...
    if (right instanceof MinusNode) {
      return new AddNode(left, ((AbstractUnaryNode) right).getSub());
    }
