 ...
 */
@Plugin(description = "Writer Factory for CA models.")
public class CAModelWriterFactory extends ModelFileWriterFactory {
  ...
  @Override
  public IModelWriter create(ParameterBlock params, Context context) {
    return new CAModelFileWriter();
  }
