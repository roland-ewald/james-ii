...
/**
 * A factory for creating CADiscreteEventProcessor objects.
 */
@Plugin(version = "1.01")
public class CADiscreteEventProcessorFactory extends JamesProcessorFactory {
   ...
   */
  private static final double EFFICIENCY = .8;
