...
public class RuleLauncher extends Grid1DLauncher {
  ...
  public static void main(String args[]) {
    ...
    RuleLauncher launcher = new RuleLauncher();
  ...
  /**
   * Checks whether the given parameter is known, if known the parameter is
